...
def get_random() -> float:
    ...
    This function makes a request to random.org to obtain a random decimal
    number in the range [0, 1) with two decimal places.

    Returns:
        float: A random decimal number with two decimal places.
